...
public class CreateProjectPage extends BaseView {
    ...
    @Step("Выбрать приоритет проекта")
    ...
    @Step("Выбрать Источник финансирования проекта")
    ...
    @Step("Выбрать бизнес-подразделение")
    ...
    @Step("Заполнить Управление конфигурацией")
